# -*- coding: utf-8 -*-
# file: cruiser_uranus_cet6.py
# author: JinTian
# time: 2018/6/26 8:26 PM
...
# ------------------------------------------------------------------------
"""
this is a cruiser sending CET6 English msg

this one maybe separately running outside of Jarvis

Using another robot to do this
but this can be a good template
...
class CETCruiser(object):
    ...
    def _main_loop(self):
        ...
        time_points_string = ['8:00', '12:00', '17:50', '19:00', '23:30']
